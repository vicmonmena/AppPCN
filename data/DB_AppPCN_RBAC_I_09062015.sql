CREATE DATABASE  IF NOT EXISTS `apppcn` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `apppcn`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win64 (x86_64)
--
-- Host: localhost    Database: apppcn
-- ------------------------------------------------------
...
CREATE TABLE `user` (
  ...
  `rol_id` smallint(6) NOT NULL DEFAULT '10',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-06-09 14:22:42
